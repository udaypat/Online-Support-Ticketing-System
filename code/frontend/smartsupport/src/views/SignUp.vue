            ...
            <form @submit.prevent="createUser" method="post">
                ...
                <div class="form-floating">
                    <input type="text" name="first_name" class="form-control" id="floatingInput" placeholder="First Name"
                        v-model="userdata.first_name" required />
                    <label for="floatingInput">First Name</label>
                </div>
                <div class="form-floating">
                    <input type="text" name="user" class="form-control" id="floatingInput" placeholder="Last Name"
                        v-model="userdata.last_name" required />
                ...
                <br />
                <div>
                    <router-link class="w-100 btn btn-lg btn-secondary" to="/" type="button">Go back
                    </router-link>
                </div>
            </form>
...
export default {
    ...
    methods: {
        createUser() {
            ...
            fetch("http://127.0.0.1:5000/api/user/register", options)
